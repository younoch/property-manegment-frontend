    ...
    <div class="grid lg:grid-cols-2 gap-3 md:gap-10 items-center">
      <div>
        ...
        <div class="mt-7 flex flex-col sm:flex-row gap-3">
          <UButton color="primary" size="lg" to="/auth/signup" class="justify-center items-center bg-primary-600 hover:bg-primary-800 text-white shadow-lg shadow-primary-200 hover:shadow-primary-300">
            Get Started Free
          </UButton>
        </div>
